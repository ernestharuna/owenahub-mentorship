<x-layouts.app>
    ...
    <div class="container my-5 animated-2 fadeIn mx-auto">
        <div class='mt-2 w-64'>
            <h2 class="fs-5 fw-semibold mt-3">Account Registration</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">Mentorship Sessions</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">User Conduct</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">Intellectual Property</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">Limitation of Liability</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">Indemnification</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">Changes to the Terms</h2>
            <ul>
            ...
            <h2 class="fs-5 fw-semibold mt-3">Governing Law</h2>
            <ul>
            ...
            <hr class="my-4">
            <h2 class="fs-5 fw-semibold mt-3">Contact Us</h2>
