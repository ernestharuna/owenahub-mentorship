        ...
        <div class="">
            <div class='mt-2'>
                ...
                <ul>
                    ...
                    <li>If you choose to provide additional information in your profile or during interactions with
                        mentors/mentees, we may collect that information as well.
                    </li>
                </ul>

                <p>Usage Information</p>
                <ul>
                    <li>We may collect information about how you interact with the Platform, including your session
                        history,
                        activity logs, and preferences.</li>
                    <li>This may include data such as the pages you visit, the duration of your sessions, and the
                        frequency of
                        your interactions.</li>
                </ul>

                <p>Device Information</p>
                <ul>
                    <li>We may collect information about the device you use to access the Platform, including its unique
                        identifiers, IP address, browser type, and operating system.
                    </li>
                </ul>
                ...
                <ul>
                    <li>We use your personal information to create and manage your account, facilitate mentorship
                        sessions, and provide support services.
                    </li>
                </ul>

                <p>Improving the Platform</p>
                <ul>
                    <li>We analyze usage data and feedback to enhance the functionality, performance, and user
                ...
                <ul>
                    <li>We may use your contact information to send you important updates, notifications, and
                        promotional materials related to the Platform.
                    </li>
                </ul>
                ...
                <ul>
                    <li>We may share your information with third-party service providers who assist us in operating the
                        Platform, such as hosting providers, analytics providers, and communication tools.</li>
                </ul>

                <p>Legal Compliance</p>
                <ul>
                    <li>We may disclose your information when required by law, court order, or other legal process, or
                        to
                ...
                <ul>
                    <li>You may update or delete your account information at any time by accessing your account
                        settings.</li>
                    <li>You have the right to access, correct, or delete your personal information. Please contact us if
                        you
                ...
                <p>If you have any questions, concerns, or feedback regarding this Privacy Policy or our data practices,
                    please
                    contact us at <a href="mailto:hello@owenahub.com">hello@owenahub.com</a>
                </p>
            </div>
        </div>
    </div>
